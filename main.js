...
const products = [
  { id:1, 
    ...
    features: ['Tecido paete', 'Tule glitter', 'Saia com tule duplo', 'Laço bordado nas costas', 'Pode incluir nome bordado', 'Todo forrado pra não incomodar a criança' ],
  ...
  { id:2, 
    ...
    features: ['Tecido paete', 'Laço temático da Minnie', 'Saia levemente rodada', 'Tecido confortável para dançar', 'Todo forrado pra não incomodar a criança' ],
  ...
  { id:3, 
    ...
    features: ['Tecido paete', 'Apliques bordados do Stitch', 'Saia multicamadas em tule glitter', 'Bordado artesanal', 'Todo forrado pra não incomodar a criança',  'Acompanha tiara'],
  ...
  { id:4, 
    ...
    features: ['Tecido paete', 'Personagens Bluey e Bingo bordados', 'Tule glitter', 'Azul celeste com detalhes laranja', 'Tecido leve e fresco', 'Todo forrado pra não incomodar a criança', 'Acompanha tiara'],
  ...
  { id:5, 
    ...
    features: ['Tecido paete', 'Tule glitter', 'Azul bebê clássico', 'Bordado artesanal', 'Todo forrado pra não incomodar a criança ', 'Acompanha tiara'],
  ...
  { id:6, 
    ...
    features: ['Tecido paete', 'Tule glitter', 'Todo forrado pra não incomodar a criança', 'Saia midi rodada', 'Tecido respirável para o verão', 'Acompanha tiara'],
  ...
  { id:7, 
    ...
    features: ['Tecido paete', 'Tule glitter',  'Verde-esmeralda com purpurina', 'Detalhes em coral', 'Todo forrado pra não incomodar a criança', 'Aplique de conchas', 'Acompanha tiara'],
  ...
  { id:8, 
    ...
    features: ['Tecido paete', 'Tule glitter', 'Verde e amarelo da seleção', 'Estrelinha bordada', 'Todo forrado pra não incomodar a criança', 'Saia rodada festiva', 'Pode personalizar com nome e número', 'Acompanha tiara'],
